...
export default function PopularEvents() {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        <div className="flex gap-6">
          {popularEvents.map((event) => (
            <div
              key={event.id}
              className="relative group rounded-2xl shadow-lg pb-3.5 bg-white min-w-[260px] max-w-xs mx-2"
              style={{ width: 260 }}
            >
              <div className="relative aspect-[4/5] overflow-hidden">
                ...
                <button
                  ...
                  aria-label={
                    isFavorited[event.id] ? "Unlike event" : "Like event"
                  }
                >
                  <svg
     ...
     <div className="mt-20 rounded-2xl px-8 flex flex-col md:flex-row items-center justify-center mx-auto md:gap-x-8">
  
  <div className="contents md:flex md:flex-col md:max-w-md md:order-1">
    <div className="order-1 md:order-1 max-w-md">
    ...
    <button className="order-3 md:order-2 mt-6 bg-black text-white px-6 py-3 rounded-full hover:bg-gray-800 transition-colors">
      Send a Free Ticket
    </button>
  </div>

  <div className="order-2 md:order-2 my-8 md:my-0 relative w-60 h-60 md:w-96 md:h-96">
    <Image
